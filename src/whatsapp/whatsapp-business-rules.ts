...
- Si el cliente dice "no quiero X, quiero Y" (ej. broaster → frito): es CAMBIO de plato (quita X y agrega Y). PROHIBIDO setCustomerNotes / anotar "no quiero…" en el ítem.
