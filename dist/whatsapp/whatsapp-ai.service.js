...
Responde SOLO JSON:
{
  ...
  "confidence": 0.0
    ...
    async generateTurn(input) {
        ...
        if (!cfg.openaiApiKey) {
            return {
                reply: 'El asistente aún no está configurado. Por favor contáctanos al *3118866823*.',
                actions: {},
            };
        }
...
${whatsapp_business_rules_1.WHATSAPP_AI_JSON_SCHEMA}`;
        ...
        try {
            ...
            if (!parsed.reply || typeof parsed.reply !== 'string') {
                return {
                    reply: 'Puedes pedir por *código* o *nombre* del producto. Ejemplo: "28" o "medio pollo". Si necesitas ayuda, contáctanos al *3118866823*.',
                };
            }
