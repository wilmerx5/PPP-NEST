...
function buildOrderLimitsPromptBlock(cfg) {
    ...
    if (cfg.maxOrderAmount > 0) {
        lines.push(`Pedido máximo por WhatsApp: $${cfg.maxOrderAmount.toLocaleString('es-CO')} COP (incluye domicilio si aplica). Si el cliente quiere más → pide contactar al *3118866823*; no confirmes.`);
    }
    if (cfg.maxUnitsPerItem > 0) {
