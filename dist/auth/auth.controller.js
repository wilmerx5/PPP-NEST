...
const verify_login_2fa_dto_1 = require("./dto/verify-login-2fa.dto");
...
let AuthController = class AuthController {
    ...
    async login2fa(dto, res) {
        const { accessToken, refreshToken, user } = await this.authService.verifyLogin2fa(dto);
    ...
    get2faStatus(req) {
        return this.authService.get2faStatus(req.user);
    }
    setup2fa(req) {
        return this.authService.setup2fa(req.user.id);
    }
    confirm2fa(req, dto) {
        return this.authService.confirm2fa(req.user.id, dto);
    }
    disable2fa(req, dto) {
        return this.authService.disable2fa(req.user.id, dto);
    }
    reveal2fa(req, dto) {
        return this.authService.reveal2fa(req.user.id, dto);
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login user and set authentication cookies (or request 2FA)' }),
    (0, swagger_1.ApiBody)({ type: login_user_dto_1.LogInUserDTO }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Logged in successfully or 2FA required' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Complete login with TOTP or recovery code' }),
    (0, swagger_1.ApiBody)({ type: verify_login_2fa_dto_1.VerifyLogin2faDto }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Logged in successfully' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Invalid 2FA code or expired temp token' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [verify_login_2fa_dto_1.VerifyLogin2faDto, Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "login2fa", null);
__decorate([
    (0, common_1.Get)('2fa/status'),
    (0, auth_decorator_1.Auth)(valid_roles_interface_1.ValidRoles.admin, valid_roles_interface_1.ValidRoles.kitchenUser, valid_roles_interface_1.ValidRoles.tableUser, valid_roles_interface_1.ValidRoles.ordersUser, valid_roles_interface_1.ValidRoles.whatsappUser),
    (0, swagger_1.ApiOperation)({ summary: 'Estado de 2FA del usuario autenticado' }),
...
__decorate([
    ...
    (0, auth_decorator_1.Auth)(valid_roles_interface_1.ValidRoles.admin, valid_roles_interface_1.ValidRoles.kitchenUser, valid_roles_interface_1.ValidRoles.tableUser, valid_roles_interface_1.ValidRoles.ordersUser, valid_roles_interface_1.ValidRoles.whatsappUser),
    (0, swagger_1.ApiOperation)({ summary: 'Iniciar setup TOTP (QR + secreto)' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, auth_decorator_1.Auth)(valid_roles_interface_1.ValidRoles.admin, valid_roles_interface_1.ValidRoles.kitchenUser, valid_roles_interface_1.ValidRoles.tableUser, valid_roles_interface_1.ValidRoles.ordersUser, valid_roles_interface_1.ValidRoles.whatsappUser),
    (0, swagger_1.ApiOperation)({ summary: 'Confirmar setup TOTP y obtener códigos de recuperación' }),
...
__decorate([
    ...
    (0, auth_decorator_1.Auth)(valid_roles_interface_1.ValidRoles.admin, valid_roles_interface_1.ValidRoles.kitchenUser, valid_roles_interface_1.ValidRoles.tableUser, valid_roles_interface_1.ValidRoles.ordersUser, valid_roles_interface_1.ValidRoles.whatsappUser),
    (0, swagger_1.ApiOperation)({ summary: 'Desactivar 2FA con código TOTP o de recuperación' }),
    (0, swagger_1.ApiBody)({ type: disable_2fa_dto_1.Disable2faDto }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, confirm_2fa_dto_1.Confirm2faDto]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "reveal2fa", null);
__decorate([
