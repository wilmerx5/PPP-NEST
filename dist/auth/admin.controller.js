...
const factus_service_1 = require("../factus/factus.service");
let AdminController = class AdminController {
    ...
    userRepo;
    pointsRepo;
    constructor(authService, pointsService, ordersService, productsService, expensesService, businessService, factusService, userRepo, pointsRepo) {
    ...
    async getAllUsers(page, limit, search, audience) {
        ...
        const staffWhere = (0, staff_roles_util_1.staffRolesSqlWhere)('user');
        const staffParams = (0, staff_roles_util_1.staffRolesSqlParams)();
    ...
    async getStaffUser(id) {
        ...
        if (!user || !(0, staff_roles_util_1.userHasStaffRole)(user.roles)) {
            throw new common_1.NotFoundException('Usuario de staff no encontrado');
        }
        return user;
    }
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Crear usuario de staff interno (activo de inmediato)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Staff user created' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar usuario de staff (roles, estado, contraseña)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Staff user updated' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_staff_user_dto_1.UpdateStaffUserDto]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "updateStaffUser", null);
__decorate([
    (0, common_1.Post)('staff/:id/reset-2fa'),
    (0, swagger_1.ApiOperation)({ summary: 'Desactivar / reiniciar 2FA de un usuario staff (sin código)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Post)('staff/:id/2fa/setup'),
    (0, swagger_1.ApiOperation)({ summary: 'Iniciar o regenerar setup TOTP para un staff (QR)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "adminSetupStaff2fa", null);
__decorate([
    (0, common_1.Post)('staff/:id/2fa/confirm'),
    (0, swagger_1.ApiOperation)({ summary: 'Confirmar setup TOTP de un staff con código de 6 dígitos' }),
    (0, swagger_1.ApiBody)({ type: confirm_2fa_dto_1.Confirm2faDto }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, confirm_2fa_dto_1.Confirm2faDto]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "adminConfirmStaff2fa", null);
__decorate([
    (0, common_1.Post)('staff/:id/2fa/disable'),
    (0, swagger_1.ApiOperation)({ summary: 'Desactivar 2FA de un staff (sin código)' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "adminDisableStaff2fa", null);
__decorate([
    (0, common_1.Post)('staff/:id/2fa/reveal'),
    ...
    __metadata("design:paramtypes", [String, confirm_2fa_dto_1.Confirm2faDto]),
    __metadata("design:returntype", void 0)
], AdminController.prototype, "adminRevealStaff2fa", null);
__decorate([
    (0, common_1.Get)('staff/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Detalle de usuario staff' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getStaffUser", null);
__decorate([
...
exports.AdminController = AdminController = __decorate([
    ...
    __param(8, (0, typeorm_2.InjectRepository)(user_points_entity_1.UserPoints)),
