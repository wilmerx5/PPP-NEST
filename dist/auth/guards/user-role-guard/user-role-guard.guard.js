...
const role_protected_decorator_1 = require("../../decorators/role-protected/role-protected.decorator");
let UserRoleGuard = class UserRoleGuard {
    ...
    canActivate(context) {
        ...
        if (!hasRole) {
            throw new common_1.ForbiddenException('User does not have permission to access this resource');
        }
        return true;
    }
};
...
//# sourceMappingURL=user-role-guard.guard.js.map