...
export declare class AdminController {
    ...
    constructor(authService: AuthService, pointsService: PointsService, ordersService: OrdersService, productsService: ProductsService, expensesService: ExpensesService, businessService: BusinessService, factusService: FactusService, userRepo: Repository<User>, pointsRepo: Repository<UserPoints>);
    getAllUsers(page?: string, limit?: string, search?: string, audience?: string): Promise<{
        data: User[];
        total: number;
    }>;
    ...
    resetStaff2fa(id: string): Promise<{
        success: boolean;
        message: string;
        user: {
            id: string;
    ...
    adminSetupStaff2fa(id: string): Promise<{
        userId: string;
        email: string;
        fullName: string;
        secret: string;
    ...
    adminConfirmStaff2fa(id: string, dto: Confirm2faDto): Promise<{
        enabled: boolean;
        userId: string;
        email: string;
        fullName: string;
    ...
    adminDisableStaff2fa(id: string): Promise<{
        success: boolean;
        message: string;
        user: {
            id: string;
    ...
    adminRevealStaff2fa(id: string, dto: Confirm2faDto): Promise<{
        userId: string;
        email: string;
        fullName: string;
        secret: string;
