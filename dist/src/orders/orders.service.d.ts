...
export declare class OrdersService {
    ...
    constructor(orderRepo: Repository<Order>, itemRepo: Repository<OrderItem>, attrRepo: Repository<OrderItemAttribute>, extraRepo: Repository<OrderExtra>, productRepo: Repository<Product>, userRepo: Repository<User>, gateway: OrdersGateway, dataSource: DataSource, pointsService: PointsService, productsService: ProductsService, businessService: BusinessService, webDelivery: WebDeliveryService, mailService: MailService, circuitBreaker: CircuitBreakerService, factusService: FactusService);
    ...
    private assertOrderContentEditable;
